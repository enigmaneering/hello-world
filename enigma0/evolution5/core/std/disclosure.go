...
// A Disclosure provides a control surface over access to a Thought.  Whoever holds a reference
// to the disclosure can control psychological access to the Thought - either by applying a Stringable code
