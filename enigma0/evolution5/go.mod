module git.enigmaneering.net/hello-world/enigma0/solution0/evolution5
...
// it literally caches the underlying source code!  If you dare, feel free to venture into the module's contents to see what the ideas
// were at this point.
//
// - Alex
