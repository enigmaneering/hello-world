...
import "git.enigmaneering.net/hello-world/enigma0/solution0/evolution3/core/std"
...
Step3 - The Nexus - Break down how to use a nexus to create endpoints
Step4 - The Impulse Engine - Break down the concept of a synapse and muting (create solutions here)
Step5 - Synaptic Signaling - Break down the different kinds of signals (stimulative vs impulsive representing goroutine activation, for example)
